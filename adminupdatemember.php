...
$memberID = $_GET['updatememberid'];
$sql = "SELECT * FROM user_form WHERE id =$memberID";
...
if(isset($_POST['update_profile'])){
   ...
   mysqli_query($conn, "UPDATE user_form SET name = '$update_name', email = '$update_email' WHERE id = '$member_id'") or die('query failed');
   ...
   if(!empty($update_pass) || !empty($new_pass) || !empty($confirm_pass)){
      if($update_pass != $old_pass){
         ...
         mysqli_query($conn, "UPDATE `user_form` SET password = '$confirm_pass' WHERE id = '$member_id'") or die('query failed');
   ...
   if(!empty($update_image)){
      if($update_image_size > 2000000){
         ...
         $image_update_query = mysqli_query($conn, "UPDATE `user_form` SET image = '$update_image' WHERE id = '$member_id'") or die('query failed');
...
<html>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <a href="memberlist.php" class="delete-btn">Go back</a>
   </form>
