...
<html>
	...
	<div class="container">
		<div class="sidebar">
            ...
            <div class="main">
                <h1 style="margin-top: -120px; margin-left: -50px; margin-bottom: 50px;">List of Admin(s)</h1>
                <table class="table">
  <thead>
    <tr>
  ...
  <tbody>
      <?php
      //sql statement to retrieve all admin records
      $sql = "SELECT adminID, adminName, adminEmail FROM admin";
      ...
      if($result) {
          while($row= mysqli_fetch_assoc($result)) {
              ...
              echo '<tr>
                    ...
                    href="adminlistupdateadmin.php?updateadminid='.$adminID.'">Update</a>
                    </button>
                    <button style="width: 100px;" class="btn btn-danger">
                    <a style="text-decoration: none;" class="text-light" 
                    href="deleteadmin.php?deleteadminid='.$adminID.'">Delete</a>
                    </button>
                    </td>   
                    </tr>';
          }
