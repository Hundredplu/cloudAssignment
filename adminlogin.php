...
if(isset($_POST['submit'])){
   ...
   $pass = mysqli_real_escape_string($conn, md5($_POST['adminpassword']));

   $select = mysqli_query($conn, "SELECT * FROM admin WHERE adminEmail = '$email' AND adminPassword = '$pass'") or die('query failed');
...
<body>
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        ?>
        <input type="email" name="adminemail" placeholder="enter email" class="box" required>
        <input type="password" name="adminpassword" placeholder="enter password" class="box" required>
